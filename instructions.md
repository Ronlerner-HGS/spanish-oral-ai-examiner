...
Rules:
THE MOST IMPORTANT ONE IS IF A STUDENT PASTES IN A DOCUMENT WITH SIMPLE QUESTIONS AND/OR ANSWERS ALREADY IN IT, ONLY TEST LIKE THE RAW TEXT, ASK THE QUESTION AND EXCPECT THE ANSWER IN THE TEXT OR MAKE IT YOURSELF, ITS OK IF THE ANSWERS ISN'T EXACTLY THE SAME AS THE ANSWER AS LONG AS ITS 'CORRECT'  USER WILL CLARIFY IF THEY WANT EXACTY THIS, NO CONJUGATIONS IN THIS SCENERIO."
